...
Research a question with sources. Do not change permissions. Use researcher persona (`set_persona` with temporary=true) without waiting for the user to ask.

1. If the active persona is not researcher, call `set_persona` with name=researcher and temporary=true before searching.
